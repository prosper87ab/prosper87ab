...
|---|---|---|---|---|
| [**Priviledge Identity Managment(PIM)**](https://github.com/EvanHYearwood/App_Integration_SAML_2.0) | Video & Screenshots Included | The purpose of implementing Privileged Identity Management (PIM) within this environment is to enforce the core security principles of Least Privilege and Just-In-Time (JIT) Access. Standard permanent administrative privileges present a massive attack surface and introduce significant risk from credential theft, lateral movement, and accidental misconfiguration.| Entra · PIM · PAM  | ![Complete](https://img.shields.io/badge/Complete-2ea44f?style=flat-square) |
| [**Sync Active Directory to the Cloud**](https://github.com/EvanHYearwood/RBAC-W-AD-Okta) | Video & Screenshots Included | This lab demonstrates well designed RBAC. | AD · Okta · SAML | ![Complete](https://img.shields.io/badge/Complete-2ea44f?style=flat-square) |
| [**Single Sign-On(SSO) and MFA**](https://github.com/EvanHYearwood/jml-automation-lab) | Video & Screenshots Included | This lab automates the JML lifecycle between Active Directory and Okta using RSA-signed JWTs for secure API communication.| AD · Okta PowerShell · OAuth 2.0 · RSA · JWT| ![Complete](https://img.shields.io/badge/Complete-2ea44f?style=flat-square)  |
| [**Compliance, Audits and User Access Reviews(UAR)**](https://github.com/EvanHYearwood/Entra-ID_AD_Prod-Environment) | Screenshots Only |In this project I configure a hybrid environment from scratch and create Operational Runbooks for common issues. This includes CA Policies, 3 Applications 2 different AuthN Protocols(OIDC + PKCE and SAML 2.0). I also do implementation testing with Microsoft Graph API, decoding SAML assertions to resolve issues, decoding JWTs to annotates ID/Access tokens, and testing CA enforcement.  | Active Directory · Entra ID · Entra Connect · Conditional Access · MFA | ![Complete](https://img.shields.io/badge/Complete-2ea44f?style=flat-square) |
| **Idendity Governance and Lifecycle Management(Joiner, Mover & Leaver)** || We'll be integrating SaaS applications with SSO and automates user provisioning and deprovisioning to maintain consistent identity lifecycle across systems.| Entra ID · Okta · SAML · OIDC · SCIM | In Progress |
